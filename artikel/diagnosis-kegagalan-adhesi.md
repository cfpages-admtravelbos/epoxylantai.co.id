---
article_id: EPL-09-02
title: "Adhesi Gagal: Coating, Primer, atau Beton yang Lepas?"
slug: "diagnosis-kegagalan-adhesi"
description: "Distinguish cohesive substrate failure, intercoat failure, contamination, weak surface, and test artefacts."
status: outline
publication_date: "2026-03-13"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: EPL-09
primary_intent: "Locate the failure plane and plausible cause."
reader_community: "Epoxylantai.co.id"
reader_address: "Sobat Epoxylantai.co.id"
final_route: "/artikel/diagnosis-kegagalan-adhesi.html"
...
# Adhesi Gagal: Coating, Primer, atau Beton yang Lepas?

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Adhesi Gagal: Coating, Primer, atau Beton yang Lepas?”
- **Reader and situation:** QA team reviewing pull-off or peeled areas.
- **Reader outcome:** Distinguish cohesive substrate failure, intercoat failure, contamination, weak surface, and test artefacts.
- **Primary intent:** Locate the failure plane and plausible cause.
...
- **Scope boundary:** Does not publish a pass/fail number; EPL-08-02 owns test design and project specification owns criteria.
- **Final public route:** `/artikel/diagnosis-kegagalan-adhesi.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Adhesi Gagal: Coating, Primer, atau Beton yang Lepas?**.
...
- `EPL-09-01` → `/artikel/diagnosis-blister-delaminasi-epoxy.html` — Lantai Epoxy Blister atau Terkelupas: Urutan Diagnosis sebelum Perbaikan
- `EPL-09-03` → `/artikel/diagnosis-pinhole-crater-fisheye.html` — Pinholes, Crater, dan Fisheye: Gejala Mirip, Penyebab Berbeda
- `EPL-09-04` → `/artikel/epoxy-lunak-lengket-tidak-curing.html` — Epoxy Lunak, Lengket, atau Tidak Curing: Cara Mengisolasi Penyebab
...
- **Tie back to this article:** Keep the explanation specific to “Adhesi Gagal: Coating, Primer, atau Beton yang Lepas?”.
