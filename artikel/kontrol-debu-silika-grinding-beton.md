---
article_id: EPL-12-03
title: "Debu Silika saat Grinding Beton: Kontrol dari Sumber sampai Housekeeping"
slug: "kontrol-debu-silika-grinding-beton"
description: "Identify dust-generating tasks, source capture/wet alternatives where compatible, isolation, housekeeping, exposure assessment, RPE gate, and verification."
status: outline
publication_date: "2026-05-29"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: EPL-12
primary_intent: "Plan silica-dust exposure controls for preparation."
reader_community: "Epoxylantai.co.id"
reader_address: "Teman Epoxylantai.co.id"
final_route: "/artikel/kontrol-debu-silika-grinding-beton.html"
...
# Debu Silika saat Grinding Beton: Kontrol dari Sumber sampai Housekeeping

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Debu Silika saat Grinding Beton: Kontrol dari Sumber sampai Housekeeping”
- **Reader and situation:** Crew and K3 team planning grinding/scarifying.
- **Reader outcome:** Identify dust-generating tasks, source capture/wet alternatives where compatible, isolation, housekeeping, exposure assessment, RPE gate, and verification.
- **Primary intent:** Plan silica-dust exposure controls for preparation.
...
- **Scope boundary:** OSHA is technical reference, not Indonesian law; no respirator or exposure value is prescribed without Indonesian K3/industrial-hygiene review.
- **Final public route:** `/artikel/kontrol-debu-silika-grinding-beton.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Debu Silika saat Grinding Beton: Kontrol dari Sumber sampai Housekeeping**.
...
- `EPL-12-01` → `/artikel/rencana-kerja-aman-lantai-resin.html` — Membuat Rencana Kerja Aman Lantai Resin dari SDS dan Tahapan Kerja
- `EPL-12-02` → `/artikel/bahaya-resin-hardener-dan-mixing.html` — Resin, Hardener, dan Mixing Exotherm: Risiko Kontak dan Reaksi
- `EPL-12-04` → `/artikel/memilih-ppe-pekerjaan-resin.html` — Memilih PPE untuk Pekerjaan Resin: Mengapa Daftar Generik Tidak Cukup
- `EPL-12-05` → `/artikel/ventilasi-dan-pajanan-area-berpenghuni.html` — Ventilasi, Uap, Aerosol, Isocyanate, dan Area Berpenghuni
...
- **Tie back to this article:** Keep the explanation specific to “Debu Silika saat Grinding Beton: Kontrol dari Sumber sampai Housekeeping”.
