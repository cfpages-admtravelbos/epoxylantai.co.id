---
article_id: EPL-02-05
title: "Survei Lantai Lama: Kontaminasi Minyak, Coating Eksisting, dan Riwayat Perbaikan"
slug: "survei-lantai-lama"
description: "Map contaminants, old layers, repairs, compatibility questions, and trial areas before demolition or overcoat."
status: outline
publication_date: "2025-10-09"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: EPL-02
primary_intent: "Assess a contaminated or previously coated floor."
reader_community: "Epoxylantai.co.id"
reader_address: "Kawan Epoxylantai.co.id"
final_route: "/artikel/survei-lantai-lama.html"
...
# Survei Lantai Lama: Kontaminasi Minyak, Coating Eksisting, dan Riwayat Perbaikan

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Survei Lantai Lama: Kontaminasi Minyak, Coating Eksisting, dan Riwayat Perbaikan”
- **Reader and situation:** Factory retrofit with unknown maintenance history.
- **Reader outcome:** Map contaminants, old layers, repairs, compatibility questions, and trial areas before demolition or overcoat.
- **Primary intent:** Assess a contaminated or previously coated floor.
- **Reader community:** `Epoxylantai.co.id`
- **Primary friendly address:** `Kawan Epoxylantai.co.id`
- **Natural variants:** `Sobat Epoxylantai.co.id` and `Teman Epoxylantai.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Does not promise a cleaner or overcoat system; EPL-05-02 owns removal decisions and EPL-11-02 owns recoat trials.
- **Final public route:** `/artikel/survei-lantai-lama.html`
...
- Open with the exact short salutation: **“Halo, Kawan Epoxylantai.co.id!”**
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Survei Lantai Lama: Kontaminasi Minyak, Coating Eksisting, dan Riwayat Perbaikan**.
- Give the short answer within the first two or three paragraphs.
- State what evidence or condition can change that answer.
- Later, sprinkle `Kawan Epoxylantai.co.id`, `Sobat Epoxylantai.co.id`, or `Teman Epoxylantai.co.id` at useful warnings, decisions, examples, or the conclusion; do not force them into every section.
...
- **Exact Markdown to insert:** `![Ilustrasi pekerjaan epoxy lantai](/wp-content/uploads/2021/02/pekerjaan-epoxy-lantai.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `pekerjaan epoxy lantai` as relevant content media; no pixels were inspected.
...
- **Purpose for this article:** Freeze the verified editorial scope for `epoxylantai.co.id` and prevent family research from overriding this project's actual catalog boundaries.
...
- **Limits:** Project acceptance requires the governing full standards, approved method/ITP, calibrated instruments, competent personnel, and actual records. ## Topic-family coverage matrix | Topic family | Main evidence records | Safe ground for the article set | Remaining gate before definitive drafting | | --- | --- | --- | --- | | `EPL-01` | KR-01, KR-14, KR-02, KR-03, KR-13, KR-15, KR-12, KR-11, KR-21 | Resin-floor fundamentals; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11, GATE-12, GATE-13, GATE-14; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. | | `EPL-02` | KR-01, KR-05, KR-06, KR-08, KR-21, KR-14, KR-18, KR-13, KR-07, KR-16, KR-09, KR-10, KR-11, KR-12 | Substrate survey and moisture; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11, GATE-12, GATE-13, GATE-14; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. | | `EPL-03` | KR-01, KR-14, KR-11, KR-09, KR-15, KR-20, KR-13, KR-02, KR-03, KR-08, KR-10, KR-18, KR-17, KR-19, KR-21 | Resin-floor system selection; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11, GATE-12, GATE-13, GATE-14; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. | | `EPL-04` | KR-01, KR-11, KR-19, KR-02, KR-03, KR-15, KR-08, KR-09, KR-10 | Use environments and operating demands; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11, GATE-12, GATE-13, GATE-14; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. | | `EPL-05` | KR-01, KR-06, KR-07, KR-08, KR-10, KR-18, KR-19, KR-05, KR-16, KR-09, KR-11, KR-14, KR-17 | Surface preparation; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11, GATE-12, GATE-13, GATE-14; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. | | `EPL-06` | KR-01, KR-05, KR-06, KR-08, KR-18, KR-14, KR-11, KR-07, KR-16, KR-09, KR-10 | Details, interfaces, cracks, and joints; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11, GATE-12, GATE-13, GATE-14; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. | | `EPL-07` | KR-01, KR-03, KR-06, KR-12, KR-21, KR-08, KR-02, KR-15, KR-05 | Installation stages and site control; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11, GATE-12, GATE-13, GATE-14; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. | | `EPL-08` | KR-01, KR-21, KR-08, KR-12, KR-18, KR-09, KR-10, KR-11, KR-17, KR-19 | QA, testing, commissioning, and handover; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11, GATE-12, GATE-13, GATE-14; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. | | `EPL-09` | KR-01, KR-05, KR-08, KR-14, KR-18, KR-21, KR-10, KR-03, KR-02, KR-15, KR-06, KR-09, KR-11, KR-12, KR-20 | Defects and root-cause diagnosis; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11, GATE-12, GATE-13, GATE-14; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. | | `EPL-10` | KR-01, KR-09, KR-11, KR-18, KR-19, KR-21, KR-13, KR-08, KR-02, KR-03, KR-15, KR-10, KR-14, KR-12, KR-07, KR-16, KR-17 | Cleaning, inspection, and maintenance; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11, GATE-12, GATE-13, GATE-14; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. | | `EPL-11` | KR-01, KR-09, KR-11, KR-17, KR-08, KR-14, KR-19, KR-18, KR-05, KR-06, KR-07, KR-16, KR-10, KR-13, KR-15, KR-20, KR-21 | Repair, recoating, and renewal; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11, GATE-12, GATE-13, GATE-14; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. | | `EPL-12` | KR-01, KR-09, KR-11, KR-16, KR-15, KR-07, KR-02, KR-03, KR-06, KR-08, KR-10, KR-17 | Chemical and task safety; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11, GATE-12, GATE-13, GATE-14; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. | | `EPL-13` | KR-01, KR-09, KR-10, KR-20, KR-02, KR-03, KR-15, KR-08, KR-11, KR-12, KR-21, KR-07, KR-16, KR-17, KR-19 | Performance and compliance claims; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11, GATE-12, GATE-13, GATE-14; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. | | `EPL-14` | KR-01, KR-20, KR-21, KR-06, KR-19, KR-02, KR-03, KR-15, KR-05, KR-08, KR-07, KR-16, KR-17 | Procurement, cost, schedule, and warranty; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11, GATE-12, GATE-13, GATE-14; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. | Coverage result: **14/14 topic families mapped; 0 families without a starting evidence set.** ## Cross-catalog fact bank 1. A definition, method, regulation, product claim, and complete-system result are different evidence layers. 2. A source supports only its stated jurisdiction, edition, product, specimen, configuration, conditions, and public scope. 3. Standards abstracts identify documents and visible scope; exact requirements require the current full text. 4. Foreign standards and industry guidance do not automatically become Indonesian legal requirements. 5. Procurement and handover claims require current project, supplier, contract, test, warranty, and traceability evidence. ## Evidence gaps and publication gates | Gate | Affected topic families | Resolution required | | --- | --- | --- | | `GATE-01` Exact product formulation and layer system | `EPL-01`, `EPL-02`, `EPL-03`, `EPL-04`, `EPL-05`, `EPL-06`, `EPL-07`, `EPL-08`, `EPL-09`, `EPL-10`, `EPL-11`, `EPL-12`, `EPL-13`, `EPL-14` | Obtain current TDS/SDS, product identity, batch, primer/body/topcoat/aggregate makeup, thickness/coverage, compatibility, and manufacturer approval | | `GATE-02` Concrete/substrate condition and moisture | `EPL-01`, `EPL-02`, `EPL-03`, `EPL-04`, `EPL-05`, `EPL-06`, `EPL-07`, `EPL-08`, `EPL-09`, `EPL-10`, `EPL-11`, `EPL-12`, `EPL-13`, `EPL-14` | Complete dated survey, slab/substrate history, moisture-source assessment, calibrated test plan/results, contamination/strength/profile evidence, and responsible review | | `GATE-03` Full standards and project acceptance | `EPL-01`, `EPL-02`, `EPL-03`, `EPL-04`, `EPL-05`, `EPL-06`, `EPL-07`, `EPL-08`, `EPL-09`, `EPL-10`, `EPL-11`, `EPL-12`, `EPL-13`, `EPL-14` | Obtain current full standards, Indonesian/local/project adoption, specified edition/method, sampling, instrument, conditions, acceptance, and qualified reviewer | | `GATE-04` Structural repair, anchoring, cracks, joints, or movement | `EPL-01`, `EPL-02`, `EPL-03`, `EPL-04`, `EPL-05`, `EPL-06`, `EPL-07`, `EPL-08`, `EPL-09`, `EPL-10`, `EPL-11`, `EPL-12`, `EPL-13`, `EPL-14` | Obtain diagnosis, loads/movement/consequence, responsible engineer's design, exact qualified product/method, inspection, and release criteria | | `GATE-05` Slip, accessibility, hygiene, food/healthcare, fire, or occupied-space claim | `EPL-01`, `EPL-02`, `EPL-03`, `EPL-04`, `EPL-05`, `EPL-06`, `EPL-07`, `EPL-08`, `EPL-09`, `EPL-10`, `EPL-11`, `EPL-12`, `EPL-13`, `EPL-14` | Define building function/users/exposure, current Indonesian/local rule, exact test/system evidence, facility review, and maintenance condition | | `GATE-06` Chemical/abrasion/impact/conductive/UV/immersion performance | `EPL-01`, `EPL-02`, `EPL-03`, `EPL-04`, `EPL-05`, `EPL-06`, `EPL-07`, `EPL-08`, `EPL-09`, `EPL-10`, `EPL-11`, `EPL-12`, `EPL-13`, `EPL-14` | Obtain exact exposure and original system test report with specimen, method, conditions, result, limitations, and project acceptance | | `GATE-07` Mixing, application, cure, and return to service | `EPL-01`, `EPL-02`, `EPL-03`, `EPL-04`, `EPL-05`, `EPL-06`, `EPL-07`, `EPL-08`, `EPL-09`, `EPL-10`, `EPL-11`, `EPL-12`, `EPL-13`, `EPL-14` | Obtain current manufacturer method, environment limits, calibrated proportioning/mixing, batch times, layer/recoat/cure criteria, protection, and responsible approval | | `GATE-08` K3, silica, chemicals, ventilation, hot work, confined/occupied work | `EPL-01`, `EPL-02`, `EPL-03`, `EPL-04`, `EPL-05`, `EPL-06`, `EPL-07`, `EPL-08`, `EPL-09`, `EPL-10`, `EPL-11`, `EPL-12`, `EPL-13`, `EPL-14` | Approve Indonesian task risk assessment, control hierarchy, competence, exposure/ventilation plan, restricted area, PPE/respiratory program, and emergency response | | `GATE-09` Waste, spill, removed coating, dust/slurry, and packaging route | `EPL-01`, `EPL-02`, `EPL-03`, `EPL-04`, `EPL-05`, `EPL-06`, `EPL-07`, `EPL-08`, `EPL-09`, `EPL-10`, `EPL-11`, `EPL-12`, `EPL-13`, `EPL-14` | Characterize each stream from SDS/testing and approve containment, transport, documentation, and authorized local route under current Indonesian rules | | `GATE-10` Defect diagnosis and remedy | `EPL-01`, `EPL-02`, `EPL-03`, `EPL-04`, `EPL-05`, `EPL-06`, `EPL-07`, `EPL-08`, `EPL-09`, `EPL-10`, `EPL-11`, `EPL-12`, `EPL-13`, `EPL-14` | Obtain chronology, original scope/batches/conditions, defect map, substrate/moisture/failure-mode evidence, tests, cause review, and remedy decision | | `GATE-11` Cleaning, maintenance, service life, and end-of-life claim | `EPL-01`, `EPL-02`, `EPL-03`, `EPL-04`, `EPL-05`, `EPL-06`, `EPL-07`, `EPL-08`, `EPL-09`, `EPL-10`, `EPL-11`, `EPL-12`, `EPL-13`, `EPL-14` | Obtain exact O&M instructions, chemical/abrasion compatibility, condition/inspection records, use/exposure history, repair threshold, and actual recovery/disposal route | | `GATE-12` Quantity, price, contractor, warranty, and commercial promise | `EPL-01`, `EPL-02`, `EPL-03`, `EPL-04`, `EPL-05`, `EPL-06`, `EPL-07`, `EPL-08`, `EPL-09`, `EPL-10`, `EPL-11`, `EPL-12`, `EPL-13`, `EPL-14` | Obtain surveyed dimensions, system take-off assumptions, current supplier/contractor quote, inclusions/exclusions, credentials, schedule, warranty terms, and legal/commercial approval | | `GATE-13` QC, case study, and handover evidence | `EPL-01`, `EPL-02`, `EPL-03`, `EPL-04`, `EPL-05`, `EPL-06`, `EPL-07`, `EPL-08`, `EPL-09`, `EPL-10`, `EPL-11`, `EPL-12`, `EPL-13`, `EPL-14` | Obtain permissioned real project records: approved scope/method/ITP, submittals, batch/environment logs, tests, nonconformance closure, acceptance, O&M, warranty, and image rights | | `GATE-14` Environmental, low-VOC, safe, non-toxic, sustainable, or food-contact claim | `EPL-01`, `EPL-02`, `EPL-03`, `EPL-04`, `EPL-05`, `EPL-06`, `EPL-07`, `EPL-08`, `EPL-09`, `EPL-10`, `EPL-11`, `EPL-12`, `EPL-13`, `EPL-14` | Define claim boundary and obtain current product declaration/test/certification, exposure/usage context, Indonesian regulatory review, and qualified environmental/health approval | ## Source-refresh triggers Recheck a record immediately when: - an Indonesian law, regulation, or official standard status changes; - a standards body publishes a new edition used by the article; - a manufacturer changes product scope, instructions, compatibility, test evidence, or warranty; - an article introduces a number, price, rating, classification, compliance statement, or safety procedure; - the target project/application differs from the exemplar's jurisdiction, user, product, configuration, or operating environment. ## Next authorized stage The later outline and constrained-writing-instruction stage may use this file only when separately authorized. Article drafting, Markdown article creation, HTML hydration, publication dating, sitemap generation, deployment, and Google Search Console submission are intentionally **not performed in this research stage**.
...
- `/pu-coating-yogyakarta` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/pu-coating-tuban` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/pu-coating-ternate` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/pu-coating-tegal` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/pu-coating-tebingtinggi` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/pu-coating-tasikmalaya` — use only if it helps the reader's next step; verify the anchor describes the destination.

### Planned sibling articles

These are future routes. Do not link them as live until their HTML exists.

- `EPL-02-03` → `/artikel/sumber-kelembapan-lantai-beton.html` — Kelembapan Naik, Sisa Pengeringan, atau Kebocoran: Melacak Sumber Air
- `EPL-02-04` → `/artikel/menilai-keutuhan-permukaan-beton.html` — Menilai Kekuatan dan Keutuhan Permukaan Beton untuk Lantai Resin
- `EPL-02-06` → `/artikel/pemetaan-kerataan-drainase-lantai.html` — Memetakan Kerataan, Kemiringan, Drainase, dan Genangan sebelum Epoxy
...
- **Tie back to this article:** Keep the explanation specific to “Survei Lantai Lama: Kontaminasi Minyak, Coating Eksisting, dan Riwayat Perbaikan”.
...
- [ ] The article opens with `Halo, Kawan Epoxylantai.co.id!` and uses friendly `Epoxylantai.co.id` community address naturally three to five times total.
