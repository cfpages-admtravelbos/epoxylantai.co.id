---
article_id: EPL-06-03
title: "Detail Terminasi Lantai Resin di Dinding, Pintu, dan Batas Area"
slug: "terminasi-lantai-resin"
description: "Compare chased, keyed, feather-edge-avoiding, threshold, wall, and adjacent-finish terminations by risk."
status: outline
publication_date: "2026-01-02"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: EPL-06
primary_intent: "Plan durable resin-floor terminations."
reader_community: "Epoxylantai.co.id"
reader_address: "Sobat Epoxylantai.co.id"
final_route: "/artikel/terminasi-lantai-resin.html"
...
# Detail Terminasi Lantai Resin di Dinding, Pintu, dan Batas Area

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Detail Terminasi Lantai Resin di Dinding, Pintu, dan Batas Area”
- **Reader and situation:** Detailer coordinating transitions and phased work.
- **Reader outcome:** Compare chased, keyed, feather-edge-avoiding, threshold, wall, and adjacent-finish terminations by risk.
- **Primary intent:** Plan durable resin-floor terminations.
...
- **Scope boundary:** Does not provide construction dimensions without system/design approval; EPL-05-05 owns physical access preparation.
- **Final public route:** `/artikel/terminasi-lantai-resin.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Detail Terminasi Lantai Resin di Dinding, Pintu, dan Batas Area**.
...
- `EPL-06-01` → `/artikel/retak-statis-atau-bergerak.html` — Retak Statis atau Bergerak? Keputusan sebelum Menutup dengan Resin
- `EPL-06-02` → `/artikel/jenis-joint-lantai-resin.html` — Construction Joint, Control Joint, dan Expansion Joint pada Lantai Resin
- `EPL-06-04` → `/artikel/detail-cove-drain-area-basah.html` — Cove, Drain, dan Kemiringan pada Area Basah
- `EPL-06-05` → `/artikel/detail-lantai-di-mesin-dan-kolom.html` — Detail di Kolom, Baseplate, Mesin, dan Jalur Forklift
...
- **Tie back to this article:** Keep the explanation specific to “Detail Terminasi Lantai Resin di Dinding, Pintu, dan Batas Area”.
