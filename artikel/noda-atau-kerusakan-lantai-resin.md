---
article_id: EPL-10-04
title: "Noda atau Kerusakan? Spot Test sebelum Deep Cleaning"
slug: "noda-atau-kerusakan-lantai-resin"
description: "Inspect, document, select a concealed representative test, observe change, rinse, and decide whether to escalate."
status: outline
publication_date: "2026-04-15"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: EPL-10
primary_intent: "Distinguish removable soil from coating damage."
reader_community: "Epoxylantai.co.id"
reader_address: "Kawan Epoxylantai.co.id"
final_route: "/artikel/noda-atau-kerusakan-lantai-resin.html"
...
# Noda atau Kerusakan? Spot Test sebelum Deep Cleaning

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Noda atau Kerusakan? Spot Test sebelum Deep Cleaning”
- **Reader and situation:** Operator considering stronger cleaning chemistry.
- **Reader outcome:** Inspect, document, select a concealed representative test, observe change, rinse, and decide whether to escalate.
- **Primary intent:** Distinguish removable soil from coating damage.
...
- **Scope boundary:** Does not recommend aggressive chemistry or repair; EPL-09-05 owns diagnosis and EPL-11-03 owns renewal.
- **Final public route:** `/artikel/noda-atau-kerusakan-lantai-resin.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Noda atau Kerusakan? Spot Test sebelum Deep Cleaning**.
...
- `EPL-10-02` → `/artikel/alat-cleaning-lantai-resin.html` — Pad, Sikat, Auto-Scrubber, dan Tekanan: Mencegah Cleaning Merusak Coating
- `EPL-10-03` → `/artikel/respon-tumpahan-kimia-lantai.html` — Menangani Tumpahan Kimia: Respon Awal, Dokumentasi, dan Eskalasi
- `EPL-10-05` → `/artikel/inspeksi-berkala-lantai-resin.html` — Inspeksi Berkala Lantai Resin: Zona, Gejala, dan Riwayat
- `EPL-10-06` → `/artikel/mengelola-slip-risk-lantai-resin.html` — Mengelola Slip Risk setelah Cleaning, Tumpahan, dan Keausan
...
- **Tie back to this article:** Keep the explanation specific to “Noda atau Kerusakan? Spot Test sebelum Deep Cleaning”.
