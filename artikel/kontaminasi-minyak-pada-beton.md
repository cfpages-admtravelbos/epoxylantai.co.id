---
article_id: EPL-05-04
title: "Kontaminasi Minyak pada Beton: Verifikasi sebelum Aplikasi Resin"
slug: "kontaminasi-minyak-pada-beton"
description: "Map contamination, distinguish surface cleaning from absorbed oil, define trials, and verify before coating."
status: outline
publication_date: "2025-12-13"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: EPL-05
primary_intent: "Plan investigation and verification for oil contamination."
reader_community: "Epoxylantai.co.id"
reader_address: "Kawan Epoxylantai.co.id"
final_route: "/artikel/kontaminasi-minyak-pada-beton.html"
...
# Kontaminasi Minyak pada Beton: Verifikasi sebelum Aplikasi Resin

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Kontaminasi Minyak pada Beton: Verifikasi sebelum Aplikasi Resin”
- **Reader and situation:** Industrial retrofit with historic oil exposure.
- **Reader outcome:** Map contamination, distinguish surface cleaning from absorbed oil, define trials, and verify before coating.
- **Primary intent:** Plan investigation and verification for oil contamination.
...
- **Scope boundary:** Gives no universal degreasing recipe or bond promise; product specialist and trial evidence own acceptance.
- **Final public route:** `/artikel/kontaminasi-minyak-pada-beton.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Kontaminasi Minyak pada Beton: Verifikasi sebelum Aplikasi Resin**.
...
- `EPL-05-02` → `/artikel/bongkar-coating-lama-atau-overcoat.html` — Bongkar Coating Lama atau Overcoat? Cara Membuat Keputusan
- `EPL-05-03` → `/artikel/laitance-debu-beton-rapuh.html` — Laitance, Debu, dan Beton Rapuh: Kapan Persiapan Harus Berhenti
- `EPL-05-05` → `/artikel/persiapan-tepi-dan-area-sulit.html` — Persiapan Tepi, Sudut, dan Area Sulit yang Sering Terlewat
- `EPL-05-06` → `/artikel/trial-area-lantai-resin.html` — Kapan Trial Area Diperlukan sebelum Lantai Resin Dikerjakan Penuh?
...
- **Tie back to this article:** Keep the explanation specific to “Kontaminasi Minyak pada Beton: Verifikasi sebelum Aplikasi Resin”.
