---
article_id: EPL-12-02
title: "Resin, Hardener, dan Mixing Exotherm: Risiko Kontak dan Reaksi"
slug: "bahaya-resin-hardener-dan-mixing"
description: "Read SDS sections, prevent skin/eye exposure, manage batch heat and incompatible handling, and define spill/escalation controls."
status: outline
publication_date: "2026-05-26"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: EPL-12
primary_intent: "Control hazards during storage, opening, proportioning, mixing, and cleanup."
reader_community: "Epoxylantai.co.id"
reader_address: "Teman Epoxylantai.co.id"
final_route: "/artikel/bahaya-resin-hardener-dan-mixing.html"
...
# Resin, Hardener, dan Mixing Exotherm: Risiko Kontak dan Reaksi

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Resin, Hardener, dan Mixing Exotherm: Risiko Kontak dan Reaksi”
- **Reader and situation:** Applicator handling two-component materials.
- **Reader outcome:** Read SDS sections, prevent skin/eye exposure, manage batch heat and incompatible handling, and define spill/escalation controls.
- **Primary intent:** Control hazards during storage, opening, proportioning, mixing, and cleanup.
...
- **Scope boundary:** Does not specify gloves, respirators, first aid, or batch size without current SDS and risk assessment.
- **Final public route:** `/artikel/bahaya-resin-hardener-dan-mixing.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Resin, Hardener, dan Mixing Exotherm: Risiko Kontak dan Reaksi**.
...
- **Tie back to this article:** Keep the explanation specific to “Resin, Hardener, dan Mixing Exotherm: Risiko Kontak dan Reaksi”.
